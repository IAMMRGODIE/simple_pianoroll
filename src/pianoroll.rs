...
pub struct EditorState {
    ...
    /// Set of note ids the alt+right scan line currently crosses; preview
    /// retriggers only when this set changes (i.e. the line enters/leaves a note).
    scanner_crossed: Option<HashSet<u64>>,
    history: Vec<Pattern>,
    history_pos: usize,
}
